    ...
    <body>
        <div class="container-fluid" style="margin-bottom: -100px">
                ...
                <div class="log-staff col-md-5" >
                    <div class="staff-box"> 
                        <div class="staff-info" >
                            <h3>${sessionScope.staff.fullname}</h3>
                            <p>${sessionScope.staff.email}</p>
                        </div>
                        <a href="StaffProfile.jsp"><img src="${sessionScope.staff.image == null ? 'img/user-icon.png' : sessionScope.staff.image}" alt=""/></a>
                    </div>
                </div>
            ...
            <div class="cata-field">
                <c:choose>
                    <c:when test="${empty param.schedule}">
                        <div class="cata-tag">
                            <a class="underlineHoverlogin" href="MainController?action=AppointmentList">
                                <h5>Appointment</h5>
                                <p>Scheduling</p>
                            </a>
                        </div> 
                ...
                <c:choose>
                    <c:when test="${empty param.medicine}">
                        <div class="cata-tag">
                            <a class="underlineHoverlogin" href="Staff_MedicineList.jsp">
                                <h5>Medicine</h5>
                ...
                <c:choose>
                    <c:when test="${empty param.services}">
                        <div class="cata-tag">
                            <a class="underlineHoverlogin" href="StaffServiceList.jsp">
                                <h5>Services</h5>
                                <p>Details & more</p>
                            </a>
                        </div> 
                ...
                <c:choose>
                    <c:when test="${empty param.doctors}">
                        <div class="cata-tag">
                            <a class="underlineHoverlogin" href="MainController?action=Search Doctor">
                                <h5>Doctors</h5>
                ...
                <c:choose>
                    <c:when test="${empty param.profile}">
                        <div class="cata-tag">
                            <a class="underlineHoverlogin" href="StaffProfile.jsp">
                                <h5>Staff Profile</h5>
