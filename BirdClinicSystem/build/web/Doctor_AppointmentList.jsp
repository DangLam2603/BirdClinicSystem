        ...
        <div class="container-form" style="position: relative; top: 0px;">
            ...
            <div class="form-white">
                <div class="row1">
                    ...
                    <div class="col-sm-4">
<!--                        <a href="Doctor_AppointmentSchedule.jsp">Show weekly schedule</a>-->
                    </div>
                            ...
                            <tr class="table-tr">
                                ...
                                <td>
                                    <div class="button-flex">
                                        <a class="underlineHoverlogin" href="MedicalRecordServlet?appID=${app.getAppID()}"><i class="fa-regular fa-file fa-xl" style="color: #40d6a8;"></i></a>
                                        <a class="underlineHoverlogin" href="PrescriptionServlet?appID=${app.getAppID()}&docID=${app.getDocID()}"><i class="fa-regular fa-clipboard fa-xl" style="color: #58d0ac;"></i></a>
                                        <a class="underlineHoverlogin" href="#disclaimer${status.index}"><i class="fa-solid fa-bars fa-xl" style="color: #40d6a8;"></i></a>
                                    </div>                      
                                </td>
                            </tr>
                        </c:forEach>
