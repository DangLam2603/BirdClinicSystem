        ...
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <span class="dropdown-container">
                    <div class="fadeIn first" style="padding: 10px; background: #95EBD1; ">                           
                        <a class="hover_div_cus" href="MainController?action=CustomerList"><i class="fa-solid fa-user-pen " style="margin: 5px; margin-right: 13px; color: black"></i>Customers</a>
                    </div>
                        ...
                        <form action="MainController" method="post">
                            <div class="row1">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <p style="margin:0px; color:rgba(201, 202, 202, 1);">Show ${totalCus} Customers</p>
                                </div>
                                <div class="col-sm-2" style="border-bottom: 1px solid">
                                    ...
                                    <button value="CustomerList" style="border:none; background-color: white;" name="action">
                                ...
                                <select name="txtsearchby" class="selecttextbox col-sm-2" style="width: 20%; margin-left: 25px">
                                    <option value="cusid" ${requestScope.searchby == 'cusid' ? 'selected' : ''}>ID</option>
                                    <option value="cusmail" ${requestScope.searchby == 'cusmail' ? 'selected' : ''}>Email</option>
                                    <option value="cusname" ${requestScope.searchby == 'cusname' ? 'selected' : ''}>Name</option>
                                    <option value="cusphone" ${requestScope.searchby == 'cusphone' ? 'selected' : ''}>Phone</option>
                                </select>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <c:url var="mylink" value="MainController">
                                                <c:param name="email" value="${customer.getEmail()}"></c:param>
                                                <c:param name="status" value="${customer.getStatus()}"></c:param>
                                                <c:param name="action" value="UpdateStatus"></c:param>
                                                <c:param name="source" value="customerList"></c:param>
                                            </c:url>
                                            <c:if test="${customer.getStatus() eq 0}">
                                                <a class="button" href="${mylink}">Active</a>
                                            </c:if>
                                            <c:if test="${customer.getStatus() eq 1}">
            ...
            <div class="form-popup-header" id="myForm">
                ...
                <form action="MainController" class="form-container" method="POST">
                    ...
                    <div style="display: flex; justify-content: center;">
                        <a href="MainController?action=CustomerList" class="button-con">Confirm</a>
