 ...
 * @author Admin
 */
public class GetBirdsNameDescServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("sortageby", null);
            request.setAttribute("keyword", "desc");
            request.setAttribute("sortby", "getBirdsNameAsc");
